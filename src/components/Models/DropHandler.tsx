...
//     const modelPath = event.dataTransfer.getData("modelPath");
//     const image = event.dataTransfer.getData("image");
//     if (!modelPath || !image || !cameraRef.current) return;

//     // Get the intersection point
//     const dropPosition = performRaycastFromMouse(event.nativeEvent, cameraRef.current, gl) || new THREE.Vector3(0, 0, 0);

//     // Pass additional properties with default values (adjust as needed)
//     await addModel(
//       modelPath,
//       [dropPosition.x, dropPosition.y, dropPosition.z],
//       image,
//       0,     // noOfBathRooms (default 0)
//       0,     // noOfBedRooms (default 0)
//       1000,  // size in SqFt (default 1000)
//       0      // price (default 0)
//     );
//   };
